export function renderDock(dockEl, activeKey) {
  const icons = {
    // NOTE: Your project structure doesn't include an app-home.png by default.
    // Option A: add one at assets/img/icons/app-home.png
    // Option B (default here): use the inline SVG home icon below.
    home: null,
